...
int main()
{
    ...
    printf("O candidato 1 teve %d votos, %f\n",cand1, percent);
    percent=(cand2/total)*100;
    printf("O candidato 2 teve %d votos, %f\n",cand2, percent);
    percent=(cand3/total)*100;
    printf("O candidato 3 teve %d votos, %f\n",cand3, percent);
    percent=(cand4/total)*100;
    printf("O candidato 4 teve %d votos, %f\n",cand4, percent);
    percent=(nulo/total)*100;
    printf("O nulo teve %d votos, %f\n",nulo, percent);
    percent=(cand1/total)*100;
    printf("O branco teve %d votos, %f\n",branco, percent);
